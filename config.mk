...
ifneq ($(MAINLINE_INCLUDE_NFCSERVICES_MODULE), false)
MAINLINE_INCLUDE_NFCSERVICES_MODULE := true
TARGET_CUSTOM_NFC_CERTIFICATE_DIR := $(TARGET_GOOGLE_APEX_CERTIFICATE_DIR)
else
TARGET_CUSTOM_NFC_CERTIFICATE_DIR ?= $(TARGET_CUSTOM_APEX_CERTIFICATE_DIR)
endif #MAINLINE_INCLUDE_NFCSERVICES_MODULE
$(shell ln -sfn \
...
ifneq ($(MAINLINE_INCLUDE_PROFILING_MODULE), false)
MAINLINE_INCLUDE_PROFILING_MODULE := true
endif #MAINLINE_INCLUDE_PROFILING_MODULE
